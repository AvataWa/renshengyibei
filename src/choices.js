...
(function (root, factory) {
  ...
  var POOL = [
    ...
    { id: 'C11', cat: 'C', name: '回炉重造', desc: '回到上一人生阶段，之后完美 +20%', flavor: '回炉不是认输，是再造。', tiers: [1, 2, 3, 4, 5, 6], fx: { backTier: true, perfectScale: 1.2 } },
    { id: 'C12', cat: 'C', name: '重启人生', desc: '回到人类幼崽，每杯得分 ×2', flavor: '若有重来，仍是少年。', tiers: [3, 4, 5, 6], fx: { restartMilk: true, scoreMult: 2 } },
    { id: 'C13', cat: 'C', name: '跳级插班', desc: '直接跳一阶，下一阶段出水 +20%', flavor: '聪明的孩子，总要付点学费。', tiers: [1, 2], fx: { jumpNextStage: true, pourRateScale: 1.2 } },
    { id: 'C14', cat: 'C', name: '退而不休', desc: '锁定当前段位，每杯 +2 分', flavor: '退了也不闲着，发挥余热。', tiers: [4, 5], fx: { lockTier: true, cupBonus: 2 } },
    { id: 'C15', cat: 'C', name: '弯道超车', desc: '直接跳一阶，下一阶段完美 −20%', flavor: '弯道快，才是真本事。', tiers: [3, 4], fx: { jumpNextStage: true, perfectScale: 0.8 } },
    { id: 'C16', cat: 'C', name: '以退为进', desc: '主动降一阶，完成范围 +30%', flavor: '退一步，路更宽。', tiers: [4, 5, 6], fx: { backStage: true, completeScale: 1.3 } },
    { id: 'C17', cat: 'C', name: '降维打击', desc: '下一阶段全用当前杯型，每杯 +1', flavor: '用熟悉的方式，打新的副本。', tiers: [3, 4, 5, 6], fx: { poolOverrideCurrent: true, cupBonus: 1 } },
    { id: 'C18', cat: 'C', name: '破圈跳槽', desc: '随机回到一个走过的段位，完美 +25%', flavor: '跳出舒适圈，圈外有惊喜。', tiers: [3, 4], fx: { jumpDownRandom: true, perfectScale: 1.25 } },
    ...
    { id: 'D11', cat: 'D', name: '天生奶量', desc: '直接晋升下一段位，完美 +1 分', flavor: '有的娃，天生奶量惊人。', tiers: [0], fx: { jumpNextTier: true, perfectBonus: 1 } },
    { id: 'D12', cat: 'D', name: '再来一瓶', desc: '白送一次完美分（不计杯数）', flavor: '盖子上写着：再来一瓶！', tiers: [1], fx: { freePerfect: true } },
    { id: 'D13', cat: 'D', name: '金榜题名', desc: '直接晋升下一段位', flavor: '十年寒窗，一朝题名。', tiers: [2], fx: { jumpNextTier: true } },
    { id: 'D14', cat: 'D', name: '天降 offer', desc: '直接晋升下一段位', flavor: '最好的 offer，总在最不经意时来。', tiers: [3], fx: { jumpNextTier: true } },
    ...
    { id: 'D20', cat: 'D', name: '环球机票', desc: '直接晋升下一段位，并预告杯型', flavor: '世界那么大，先升一段看看。', tiers: [4, 5, 6], fx: { jumpNextTier: true, cupPreview: true } },
