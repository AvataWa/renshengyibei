...
(function (root, factory) {
  ...
  var CUPS = [
    // ── 段位0 · 倒奶（10 个杯型，低难度：杯型规则、合格区宽，无 S 曲线）──
    {
    ...
    {
      name: '胖牛奶杯', hint: '八分满', aspect: 1.1, stem: false, size: 1.0,
      profile: tableProfile([
        0.66, 0.75, 0.78, 0.78, 0.78, 0.78,
        0.78, 0.78, 0.78, 0.78, 0.78, 0.78,
        0.78, 0.78, 0.78, 0.78, 0.78]),
      zones: { q: [0.66, 0.94] }
    },
    {
      name: '小圆奶杯', hint: '七分满', aspect: 0.8, stem: false, size: 0.9,
      profile: tableProfile([
        0.34, 0.44, 0.53, 0.61, 0.68, 0.74,
        0.79, 0.83, 0.86, 0.89, 0.91, 0.92,
        0.93, 0.94, 0.94, 0.95, 0.95]),
      zones: { q: [0.58, 0.88] }
    },
    {
      name: '方底奶樽', hint: '八分满', aspect: 1.3, stem: false, size: 1.0,
      profile: tableProfile([
        0.62, 0.64, 0.66, 0.68, 0.7, 0.72,
        0.73, 0.75, 0.76, 0.78, 0.79, 0.8,
        0.81, 0.82, 0.83, 0.84, 0.85]),
      zones: { q: [0.64, 0.92] }
    },
    {
      name: '矮胖马克杯', hint: '八分满', aspect: 1.0, stem: false, size: 1.05,
      deco: { handle: true },
      profile: tableProfile([
        0.72, 0.8, 0.84, 0.85, 0.85, 0.85,
        0.85, 0.85, 0.85, 0.85, 0.85, 0.85,
        0.85, 0.85, 0.85, 0.85, 0.85]),
      zones: { q: [0.66, 0.94] }
    },
    {
      name: '圆肚小罐', hint: '半罐正好', aspect: 1.0, stem: false, size: 1.0,
      profile: tableProfile([
        0.42, 0.52, 0.62, 0.7, 0.76, 0.8,
        0.82, 0.82, 0.8, 0.77, 0.73, 0.69,
        0.65, 0.61, 0.58, 0.56, 0.55]),
      zones: { q: [0.52, 0.82] } // 单鼓肚收口：中段慢、近目标变快
    },
    {
      name: '直筒刻度杯', hint: '八分满', aspect: 1.5, stem: false, size: 1.0,
      deco: { ticks: 5 },
      profile: tableProfile([
        0.62, 0.7, 0.73, 0.73, 0.73, 0.73,
        0.73, 0.73, 0.73, 0.73, 0.73, 0.73,
        0.73, 0.73, 0.73, 0.73, 0.73]),
      zones: { q: [0.66, 0.92] }
    },
    {
      name: '敞口早餐杯', hint: '七分满', aspect: 0.9, stem: false, size: 1.0,
      profile: tableProfile([
        0.5, 0.54, 0.58, 0.62, 0.66, 0.7,
        0.73, 0.77, 0.8, 0.84, 0.87, 0.9,
        0.93, 0.96, 0.98, 0.99, 1.0]),
      zones: { q: [0.60, 0.90] }
    },
    {
      name: '小高脚奶杯', hint: '七分满', aspect: 1.2, stem: true, size: 1.0,
      profile: tableProfile([
        0.3, 0.4, 0.49, 0.57, 0.64, 0.69,
        0.73, 0.76, 0.78, 0.79, 0.79, 0.78,
        0.77, 0.75, 0.73, 0.71, 0.7]),
      zones: { q: [0.60, 0.90] }
    },
    {
      name: '瘦高奶瓶', hint: '九分满', aspect: 2.0, stem: false, size: 1.1,
      profile: tableProfile([
        0.34, 0.38, 0.4, 0.4, 0.4, 0.4,
    ...
    // ── 段位1 · 可乐少年 +2 ──
    {
      name: '可乐收腰杯', hint: '过腰线', aspect: 1.6, stem: false, size: 1.0,
      profile: tableProfile([
        0.6, 0.64, 0.67, 0.69, 0.7, 0.7,
        0.69, 0.67, 0.64, 0.61, 0.59, 0.58,
        0.59, 0.61, 0.64, 0.67, 0.7]),
      zones: { q: [0.60, 0.88] } // 单收腰：过腰时加速（单向变化，非 S 曲线）
    },
    {
      name: '竖纹汽水罐', hint: '九分满', aspect: 2.2, stem: false, size: 1.2,
      deco: { ticks: 8 },
      profile: tableProfile([
        0.4, 0.44, 0.46, 0.46, 0.46, 0.46,
    ...
    // ── 段位2 · 啤酒青年 +2 ──
    {
      name: '扎啤马克杯', hint: '九分满', aspect: 1.4, stem: false, size: 1.15,
      deco: { handle: true },
      profile: tableProfile([
        0.66, 0.68, 0.7, 0.72, 0.73, 0.75,
        0.76, 0.78, 0.79, 0.8, 0.81, 0.82,
        0.83, 0.84, 0.85, 0.86, 0.87]),
      zones: { q: [0.70, 0.96] }
    },
    {
      name: '皮尔森杯', hint: '八分满', aspect: 1.9, stem: false, size: 1.1,
      profile: tableProfile([
        0.3, 0.33, 0.36, 0.4, 0.44, 0.48,
        0.52, 0.56, 0.6, 0.64, 0.68, 0.72,
        0.76, 0.8, 0.83, 0.86, 0.88]),
      zones: { q: [0.68, 0.92] } // 细底阔口：起步蹿得快，后段放缓
    },
    // ── 段位3 · 红酒新秀 +2 ──
    {
      name: '波尔多酒杯', hint: '1/3 杯', aspect: 1.5, stem: true, size: 1.08,
      profile: tableProfile([
        0.2, 0.3, 0.42, 0.53, 0.63, 0.71,
        0.77, 0.81, 0.83, 0.83, 0.81, 0.78,
        0.74, 0.69, 0.64, 0.59, 0.55]),
      zones: { q: [0.28, 0.52] } // 目标区低：起步冲得猛，考验早停
    },
    {
      name: '勃艮第胖杯', hint: '1/3 杯', aspect: 1.2, stem: true, size: 1.15,
      profile: tableProfile([
        0.24, 0.36, 0.5, 0.63, 0.74, 0.83,
        0.89, 0.92, 0.92, 0.89, 0.84, 0.78,
        0.71, 0.65, 0.59, 0.54, 0.5]),
      zones: { q: [0.26, 0.50] } // 大肚低目标：超慢爬升
    },
    // ── 段位4 · 白酒骨干 +2 ──
    {
      name: '白酒分酒盅', hint: '满杯为宜', aspect: 0.9, stem: false, size: 0.7,
      profile: tableProfile([
        0.36, 0.44, 0.51, 0.57, 0.62, 0.66,
        0.69, 0.72, 0.74, 0.76, 0.77, 0.78,
        0.79, 0.79, 0.8, 0.8, 0.8]),
      zones: { q: [0.72, 0.96] } // 小盅目标贴顶：余量极小
    },
    {
      name: '细颈酒壶杯', hint: '过肚一半', aspect: 1.7, stem: false, size: 1.06,
      profile: tableProfile([
        0.3, 0.42, 0.54, 0.64, 0.72, 0.78,
        0.81, 0.82, 0.8, 0.75, 0.68, 0.6,
        0.51, 0.43, 0.36, 0.32, 0.3]),
      zones: { q: [0.42, 0.68] } // 低肚细颈：过颈后猛地加速
    },
    // ── 段位5 · 茶道宗师 +2 ──
    {
      name: '盖碗茶杯', hint: '七分满', aspect: 0.55, stem: false, size: 1.1,
      profile: tableProfile([
        0.3, 0.38, 0.46, 0.54, 0.61, 0.68,
        0.74, 0.79, 0.83, 0.87, 0.9, 0.92,
        0.94, 0.95, 0.96, 0.97, 0.97]),
      zones: { q: [0.55, 0.80] } // 宽浅盖碗：液面爬得极慢，耐心局
    },
    {
      name: '竹节茶杯', hint: '八分满', aspect: 1.7, stem: false, size: 1.0,
      deco: { ticks: 3 },
      profile: tableProfile([
        0.44, 0.47, 0.49, 0.51, 0.53, 0.55,
        0.56, 0.58, 0.59, 0.6, 0.61, 0.62,
  ...
  // cupCount = 该段位解锁的杯型数量（10 + 2 × 段位索引，共 20 种杯型，超出自动封顶）
  var TIERS = [
